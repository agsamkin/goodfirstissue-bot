...
public interface GitHubService {
    ...
    Map<String, Long> getRepoLanguages(GHRepository ghRepo) throws GHRepoLanguagesGettingException, GHRateLimitException;

    GHRepository getRepoByRepoId(Long repoId) throws GHRepoGettingException, GHRateLimitException;
    List<GHRepository> getReposByLanguage(Language language, Date updatedFrom) throws GHRateLimitException;
    List<GHRepository> getReposByLanguage(Language language) throws GHRateLimitException;

    GHIssue getIssueFromRepoByNumber(GHRepository ghRepo, Integer number) throws GHIssueGettingException, GHRateLimitException;
    List<GHIssue> getIssuesByRepo(GHRepository ghRepo, Date since) throws GHRateLimitException;
